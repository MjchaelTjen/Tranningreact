                    ...
                    <div className="col-6">
                        ...
                        <div className="card">
                            ...
                            <div className="card-body">
                                ...
                                <div className="row mt-2 border">
                                    <div className="col-2">
                                        <img style={{ cursor: "pointer" }} onClick={() => this.setState({ imgSrc: "./img/car/products/red-car.jpg" })} src="./img/car/icons/icon-red.jpg" className="w-100"></img>
                                    </div>
                                    <div className="col-10">
                                        <h3>Red color</h3>
                                    </div>
                                ...
                                <div className="row mt-2 border">
                                    <div className="col-2">
                                        <img style={{ cursor: "pointer" }} onClick={() => this.setState({ imgSrc: "./img/car/products/steel-car.jpg" })} src="./img/car/icons/icon-steel.jpg" className="w-100"></img>
                                    </div>
                                    <div className="col-10">
                                        <h3>Steel color</h3>
                                    </div>
